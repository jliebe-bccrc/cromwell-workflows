...
#
# Update Notes: 
# Taken from Mutect2 workflow written by GATK/Broad; modified by Aparicio Lab (BCCRC), June 2022, to output just MAF funcotated file given an input filtered VCF
...
workflow MafFuncotator {
    ...
    call Funcotate {
        input:
            ...
            output_file_base_name          = sample_ID + "-variants.funcotated",
...
task Funcotate {
    ...
    Int default_disk_space_gb = ceil(ref_size_gb + (ds_size_gb * 2) + (vcf_size_gb * 10)) + 80
